...
# from .blocks.unetr_block import UnetrUpBlock
...
#                     )
    ...
    def forward(self, x):
        ...
        # print('skip_e0:', enc0.shape)
        # print('skip_e1:', enc1.shape)
        # print('skip_e2:', enc2.shape)
        # print('skip_e3:', enc3.shape)
        # print('skip_e4:', enc4.shape)
